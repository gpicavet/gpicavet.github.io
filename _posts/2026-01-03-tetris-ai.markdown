...
<img src="https://github.com/gpicavet/tetris_ai/raw/master/assets/tetris.gif" alt="screencast" width="300"/>
...
The output returns the Q-value for a given state.
There are 2 hidden layers of size 128 ( it's a good tradeoff between training speed & precision)
